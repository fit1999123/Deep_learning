...
x_train_normal = x_train_normal.reshape(50000,32,32,3)
x_test_normal = x_test_normal.reshape(10000,32,32,3)
...
model.add(Conv2D(filters=36,kernel_size=(5,5),padding="same",input_shape=(32,32,3),activation="relu"))
...
model.fit(x=x_train_normal,y=y_cateorical_train,epochs=10)
